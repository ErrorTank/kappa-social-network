...
var exceptionRequestsDev = [
  ...
  {
    endpoint: 'https://localhost:4000/api/dating/like-profiles',
    method: 'GET',
  },
  {
  ...
  {
    endpoint: /https:\/\/localhost:4000\/api\/dating\/edit-profile\/profileId\/\w+/,
    method: 'PUT',
  },
  {
    endpoint: /https:\/\/localhost:4000\/api\/dating\/update-filter\/profileId\/\w+/,
    method: 'PUT',
  },
  {
  ...
  {
    endpoint: /https:\/\/localhost:4000\/api\/user\/\w+\/settings/,
    method: 'GET',
  },
  {
    endpoint: /https:\/\/localhost:4000\/api\/user\/\w+\/settings/,
  ...
  {
    endpoint: /https:\/\/localhost:4000\/api\/user\/\w+\/change-password/,
    method: 'PUT',
  },
  {
  ...
  {
    endpoint: /https:\/\/localhost:4000\/api\/user\/\w+\/school\/\w+/,
    method: 'DELETE',
  },
  {
  ...
  {
    endpoint: /https:\/\/localhost:4000\/api\/user\/\w+\/check-block\/\w+/,
    method: 'GET',
  },
  {
  ...
  {
    endpoint: /https:\/\/localhost:4000\/api\/listing\/get-listing-by-userID\/\w+/,
    method: 'GET',
  },
  {
    endpoint: /https:\/\/localhost:4000\/api\/listing\/get-listing-by-listingID\/\w+/,
    method: 'GET',
  },
  {
    endpoint: /https:\/\/localhost:4000\/api\/listing\/edit-listing/,
    method: 'PUT',
  },
  {
    endpoint: /https:\/\/localhost:4000\/api\/listing\/save-listing\/\w+/,
    method: 'PUT',
  },
  {
    endpoint: /https:\/\/localhost:4000\/api\/listing\/update-stock\/\w+/,
    method: 'PUT',
  },
  {
    endpoint: /https:\/\/localhost:4000\/api\/listing\/get-saved-listing\/\w+/,
    method: 'GET',
  },
  {
