...
const ProfileFeed = lazy(
    delayLoad(() =>
        import('./authen-routes/user-profile-route/upr-body/profile-feed/profile-feed')
    )
);
const ProfileAbout = lazy(
    delayLoad(() =>
        import('./authen-routes/user-profile-route/upr-body/profile-about/profile-about')
    )
);
const ProfileFriends = lazy(
    delayLoad(() =>
        import('./authen-routes/user-profile-route/upr-body/profile-friend/profile-friend')
    )
);
                                                ...
                                                {(uprProps) => (
                                                    <>
                                                        <Route
                                                            exact
                                                            path={'/user/:userID'}
                                                            render={(props) => <ProfileFeed {...props} {...uprProps}/>}
                                                        />
                                                        <Route
                                                            exact
                                                            path={'/user/:userID/about'}
                                                            render={(props) => <ProfileAbout {...props} {...uprProps}/>}
                                                        />
                                                        <Route
                                                            exact
                                                            path={'/user/:userID/friends'}
                                                            render={(props) => <ProfileFriends {...props} {...uprProps}/>}
                                                        />
                                                    </>
                                                )}
                                            </UserProfileRoute>
