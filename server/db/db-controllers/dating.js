...
const getCardProfileInfo = (userID, {seenID, action, exclude}) => {
    return Profile.findOneAndUpdate(
        ...
        .then((user) => {
            ...
            if (["A-LEVELS,HIGHERS OR EQUIVALENT", "BACHELORS DEGREE", "UNIVERSITY(POSTGRADUATE) DEGREE"].includes(user.filterSetting.educationLevel)) {
                match.educationLevel = user.filterSetting.educationLevel;
            }
            if (["AGNOSTIC", "ATHEIST", "BUDDHIST", "CATHOLIC", "CHRISTIAN", "HINDU", "BUDDHJEWISHIST", "MUSLIM", "SIKH", "SPIRITUAL"].includes(user.filterSetting.religion)) {
